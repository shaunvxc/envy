...
Ever wanted to directly edit or put a breakpoint in a virtualenv's copy of a file **without** having to aving to type out `~/.virtualenvs/blah/lib/pythonX.X/andd_you_get_itt`? `envy edit` to the rescue!
