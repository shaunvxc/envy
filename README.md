...
and you'll instantly be looking at the point-of-error from your favorite text editor!  This is pretty awesome, considering that this would normally require typing out (or copy pasting-- which **is also** annoying) something like:                                `~/.virtualenvs/foo/lib/pythonX.X/site-packages/bar/baz.py`  
